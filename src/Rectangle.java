/**
 * Models a simple, solid rectangle. This class represents a Rectabgle object.
 * When combined with the GameArena class, instances of the Rectangle class can
...
public class Rectangle {
	 ...
	 *
	 * @param x
	 *            the new x co-ordinate of this Rectangle
	 */
	 ...
	 *
	 * @param y
	 *            the new y co-ordinate of this Rectangle
	 */
	 ...
	 *
	 * @param width
	 *            The new width of this rectangle, in pixels.
	 */
	 ...
	 *
	 * @param height
	 *            The new height of this rectangle, in pixels.
	 */
	 ...
	 *
	 * @param input
	 *            the new colour of this Rectangle
	 */
	...
	/**
	 * Set the attributes according to other one
	 *
	 * @param other
	 */
	public void reset(Rectangle other) {
	...
	public boolean isTouching(Rectangle r) {
		return (xPosition - width / 2 < r.getXPosition() + r.getWidth() / 2
				...
				&& yPosition - height / 2 < r.getYPosition() + r.getHeight()
						/ 2 && yPosition + height / 2 > r.getYPosition()
				- r.getHeight() / 2);
	}
